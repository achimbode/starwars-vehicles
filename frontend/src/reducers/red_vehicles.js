...
const vehiclesReducer = (vehiclesState = {}, action) => {
  // console.log(action.vehi);
  switch (action.type) {
    case 'ADD_VEHICLES':
      console.log('reducer: new vehicles = ');
      let newVehiclesState = {
        ...vehiclesState,
        ...urlify(action.vehicles),
      }
...
//console.log(urlify(arrTestVehicles.results));
